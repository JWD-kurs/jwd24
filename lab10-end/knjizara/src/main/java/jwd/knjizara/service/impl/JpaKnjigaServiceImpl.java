...
public class JpaKnjigaServiceImpl implements KnjigaService {
	...
	@Override
	public Page<Knjiga> pretraga(String naziv, String pisac, Integer maxKolicina, int page) {
		if(naziv != null ){
			naziv = "%" + naziv + "%";
		}
		...
		return knjigaRepository.pretraga(naziv, pisac, maxKolicina, new PageRequest(page, 5));
	}
